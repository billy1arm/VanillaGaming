...
-- 瘟疫花
UPDATE `gameobject` SET `spawntimesecs`='3600' WHERE (`id`='176587');
UPDATE `gameobject` SET `spawntimesecs`='3600' WHERE (`id`='176641');

-- 山鼠草
UPDATE `gameobject` SET `spawntimesecs`='3600' WHERE (`id`='176586');
UPDATE `gameobject` SET `spawntimesecs`='3600' WHERE (`id`='176640');
UPDATE `gameobject` SET `spawntimesecs`='3600' WHERE (`id`='180166');
...
-- 冰盖草
UPDATE `gameobject` SET `spawntimesecs`='3600' WHERE (`id`='176588');
