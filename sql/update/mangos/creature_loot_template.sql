...
-- 辛迪加潜伏者 --- 激流堡符印
UPDATE `creature_loot_template` SET `ChanceOrQuestChance`='-100' WHERE (`entry`='2588') AND (`item`='4440');
...
-- 辛迪加咒术师 --- 激流堡符印
UPDATE `creature_loot_template` SET `ChanceOrQuestChance`='-100' WHERE (`entry`='2590') AND (`item`='4440');

-- 辛迪加咒术师 --- 激流堡徽章
UPDATE `creature_loot_template` SET `ChanceOrQuestChance`='-80' WHERE (`entry`='2590') AND (`item`='4506');

-- 辛迪加占星师 --- 激流堡符印
UPDATE `creature_loot_template` SET `ChanceOrQuestChance`='-100' WHERE (`entry`='2591') AND (`item`='4440');
...
-- 被污染的科尔宝石
UPDATE `creature_loot_template` SET `ChanceOrQuestChance`='-100' WHERE `item`='6995';
