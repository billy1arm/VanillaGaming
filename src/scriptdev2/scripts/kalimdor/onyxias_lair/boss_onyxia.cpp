...
enum
{
    ...
    // 一阶段
    SPELL_TAILSWEEP             = 15847,                    // 龙尾扫击
    SPELL_FLAMEBREATH           = 18435,                    // 火息术
    SPELL_WINGBUFFET            = 18500,                    // 龙翼攻击
    SPELL_KNOCK_AWAY            = 19633,                    // 击退
    SPELL_CLEAVE                = 19983,                    // 顺劈斩

    // 二阶段
    SPELL_SUMMONWHELP           = 17646,                    // 召唤奥妮克希亚雏龙
    SPELL_FIREBALL              = 18392,                    // 火球术
    ...
    PHASE_BREATH                = 2,                        // 二阶段
    PHASE_END                   = 3,                        // 三阶段
    PHASE_BREATH_POST           = 4,                        // 落地
    PHASE_TO_LIFTOFF            = 5,                        // 起飞
    PHASE_BREATH_PRE            = 6                         // 飞向巢穴北
};
...
{
    {SPELL_BREATH_NORTH_TO_SOUTH,  24.16332f, -216.0808f, -58.98009f},  // 北
    {SPELL_BREATH_NE_TO_SW,        10.2191f,  -247.912f,  -60.896f},    // 东北
    {SPELL_BREATH_EAST_TO_WEST,   -15.00505f, -244.4841f, -60.40087f},  // 东
    {SPELL_BREATH_SE_TO_NW,       -63.5156f,  -240.096f,  -60.477f},    // 东南
    {SPELL_BREATH_SOUTH_TO_NORTH, -66.3589f,  -215.928f,  -64.23904f},  // 南
    {SPELL_BREATH_SW_TO_NE,       -58.2509f,  -189.020f,  -60.790f},    // 西南
    {SPELL_BREATH_WEST_TO_EAST,   -16.70134f, -181.4501f, -61.98513f},  // 西
    {SPELL_BREATH_NW_TO_SE,        12.26687f, -181.1084f, -60.23914f},  // 西北
};

static const float afSpawnLocations[3][3] =
{
    { -30.127f, -254.463f, -89.440f},                       // 奥妮克希亚雏龙
    { -30.817f, -177.106f, -89.258f},                       // 奥妮克希亚雏龙
};
...
struct boss_onyxiaAI : public ScriptedAI
{
    ...
    {
        if (pSpell->Id == SPELL_BREATH_EAST_TO_WEST || pSpell->Id == SPELL_BREATH_WEST_TO_EAST || pSpell->Id == SPELL_BREATH_SE_TO_NW || pSpell->Id == SPELL_BREATH_NW_TO_SE || pSpell->Id == SPELL_BREATH_SW_TO_NE || pSpell->Id == SPELL_BREATH_NE_TO_SW || pSpell->Id == SPELL_BREATH_SOUTH_TO_NORTH || pSpell->Id == SPELL_BREATH_NORTH_TO_SOUTH)
        {
